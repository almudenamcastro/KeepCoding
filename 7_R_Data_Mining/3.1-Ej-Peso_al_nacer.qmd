...
Leer el dataset que se encuentra en data/birthweight_reduced.csv. Quedarse con la columnas Birthweight y smoker. Es un dataset donde se muestra el peso de los bebes al nacer de madres fumadoras y no fumadoras.
